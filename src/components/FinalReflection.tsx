...
export function FinalReflection() {
  return (
    <section className="relative overflow-hidden px-5 pb-44 pt-28 sm:px-8 lg:px-12">
      <div
        className="curtain-layer pointer-events-none absolute inset-x-0 top-0 h-[26rem] opacity-[0.72] sm:h-[30rem]"
        style={{ backgroundImage: `url(${stageCurtains})`, backgroundSize: 'contain', backgroundRepeat: 'no-repeat', backgroundPosition: 'top center' }}
      />
      <div className="pointer-events-none absolute inset-x-0 top-0 h-[28rem] bg-gradient-to-b from-transparent via-transparent to-ink/90 sm:h-[32rem]" />
      <div
